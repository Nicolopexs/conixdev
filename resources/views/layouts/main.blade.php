...
<head>
  ...
  <script>(function(){try{if(localStorage.getItem('conixdev_theme')==='light'){document.documentElement.classList.add('light-theme');}}catch(e){}})();</script>
  ...
  <header class="nav-header">
    <div class="container nav-container">
      ...
      <ul class="nav-links-wrap" id="navLinksWrap">
        ...
        <li><a href="{{ url('/contacto') }}" class="btn-action btn-primary-glow" style="padding: 0.45rem 1rem; font-size: 0.85rem;">Contacto</a></li>
        <li>
