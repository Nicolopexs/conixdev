...
<section style="padding-top: 6.5rem; padding-bottom: 1rem;">
  <div class="container">
    ...
    <span class="trust-badge" style="margin-bottom: 0.75rem;">Caso de Estudio Estrella</span>
    <h1 class="title-hero" style="margin-bottom: 0.75rem;">
      Caso de Éxito: <span class="text-gradient">Cassará Ecuador</span>
    </h1>
    <p style="font-size: 1.15rem; color: var(--text-muted); max-width: 820px; line-height: 1.6;">
...
<section class="section-spacing" style="padding-top: 0.5rem;">
  <div class="container">
    ...
    <div style="margin-bottom: 3rem;">
      <div style="text-align: center; max-width: 750px; margin: 0 auto 1.25rem;">
