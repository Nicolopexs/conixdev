...
<section style="padding-top: 6.5rem; padding-bottom: 1.5rem; position: relative;">
  ...
  <div class="container" style="text-align: center;">
    <div class="trust-badge" style="margin-bottom: 0.75rem;">
      ...
      Desarrollo de Software Local en Ecuador & Quito
    </div>
  ...
  <div class="container" style="max-width: 850px;">
    ...
    <div style="display: flex; flex-direction: column; gap: 1.25rem;">
      <div class="card-box">
        ...
        <p class="body-sm">Contratar a ConixDev te ofrece el respaldo de un equipo de desarrollo responsable localmente en Ecuador, contratos formales bajo legislación ecuatoriana, atención directa sin diferencias de horario y cumplimiento con estándares locales.</p>
      </div>
  ...
  <div class="container">
    <div class="contact-simple-card">
      <div style="text-align: center; margin-bottom: 2rem;">
        ...
        <h2 class="title-section" style="margin-bottom: 0.5rem;">Hablar con un <span class="text-gradient">Especialista de ConixDev</span></h2>
