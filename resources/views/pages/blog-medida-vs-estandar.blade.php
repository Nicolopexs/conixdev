...
<article style="padding-top: 7.5rem; padding-bottom: 5rem;">
  <div class="container" style="max-width: 850px;">
    <div class="trust-badge" style="margin-bottom: 1.25rem;">
      <span class="trust-badge-dot"></span>
      Criterios de Decisión Ejecutiva
    </div>

    <h1 class="title-hero" style="font-size: clamp(2rem, 3.5vw, 2.75rem); margin-bottom: 1.5rem; line-height: 1.25;">
      Software a Medida vs. <span class="text-gradient">Software Comercial Estándar</span>
    </h1>

    <div style="display: flex; gap: 1.5rem; align-items: center; color: var(--text-muted); font-size: 0.9rem; margin-bottom: 2.5rem; border-bottom: 1px solid var(--border-subtle); padding-bottom: 1.25rem;">
